...
namespace IMAPI2.Interop
{
    ...
    #endregion
    //main image writer (implemet for receive notifications of the current write operation)
    ...
    //disk eraser (implemet for receive notifications of the current erase operation)
    ...
    //raw image writer (implemet for receive notifications of the current raw-image operation)
    ...
    //track at once image writer (implemet for receive notifications of the current track-writing operation)
    ...
    //notification delegate for the MsftDiscMaster2 object (enumeration of disc devices in the system hardware list)
    ...
    //low-level burn engine (implemet for receive notifications of the current write operation)
    ...
    public interface IDiscFormat2Data
    {
        ...
        // Determines if the recorder object supports the given format
        [DispId(0x800)]
        long IsRecorderSupported(IDiscRecorder2 Recorder);
